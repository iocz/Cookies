...
public class RegistrationForm extends JFrame{
    ...
    public void registration(){
        try {
            UserVoids.registration(loginTF.getText(), new String(onePassTF.getPassword()), new String(twoPassTF.getPassword()), Resources.traditions, Resources.countries, Resources.holidays);
        } catch (IOException e) {
